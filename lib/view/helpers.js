...
module.exports = function(){
  return {
    ...
    t: function(i18n_key, dynamicValues, options) {

      const values = options ? dynamicValues : null
      const i18n = options ? options.data.root.i18n : dynamicValues.data.root.i18n

      var result = i18n.t(i18n_key, values);
