            ...
            team_view
                ...
                .then(team_view_details =>
                    res.render("team_view", {
                        ...
                        related_departments:
                            team_view_details.related_departments,
                        current_department:
                            team_view_details.current_department,
                        company: company
                    })
                );
        }
...
router.post("/feeds/regenerate/", function(req, res) {
    ...
    req.user
        .getFeeds()
        .then(function(feeds) {
            var the_feed = _.findWhere(feeds, {
                feed_token: req.param("token")
            });
